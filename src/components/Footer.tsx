      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            <div className="mb-5">
              <Image src="/logo.png" alt="HAPI Health TX" width={140} height={50} className="h-12 w-auto object-contain brightness-0 invert" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                <Phone size={15} className="text-[#cc1230] mt-0.5 shrink-0" />
                <div>
                  <a href="tel:+18325551234" className="text-white font-semibold hover:text-red-300 transition-colors">(832) 555-1234</a>
                  <p className="text-gray-500 text-xs mt-0.5">24/7 on-call nursing</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Mail size={15} className="text-[#cc1230] mt-0.5 shrink-0" />
                <a href="mailto:info@hapihealthtx.com" className="text-gray-400 hover:text-white transition-colors">info@hapihealthtx.com</a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin size={15} className="text-[#cc1230] mt-0.5 shrink-0" />
                <span className="text-gray-400">Houston, TX &amp; Harris County</span>
              </li>
            </ul>
            <div className="mt-6 bg-[#1b3a6b] rounded-xl p-4">

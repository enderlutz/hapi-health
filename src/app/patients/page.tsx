    ...
    <>
      ...
      <section className="relative min-h-[50vh] flex items-end">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pb-14 pt-40">
          <p className="text-red-300 font-bold text-sm uppercase tracking-widest mb-3">Patient Resources</p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-14">
            <p className="text-[#cc1230] font-bold text-sm uppercase tracking-widest mb-3">Your Care Journey</p>
            <h2 className="text-4xl font-extrabold text-[#1b3a6b]">What to Expect</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
            {[
              ...
              { n: '02', h: 'Insurance Verified', b: 'We contact your insurance — Medicare, Medicaid, or private — and confirm your coverage. We handle every form. You pay nothing for this step.' },
              ...
              <div key={s.n} className="flex gap-6 items-start">
                <span className="text-6xl font-extrabold text-gray-100 leading-none select-none shrink-0 mt-1">{s.n}</span>
                <div>
                  <h3 className="text-xl font-extrabold text-[#1b3a6b] mb-2">{s.h}</h3>
      ...
      <section className="py-24 bg-[#f8f7f4]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <p className="text-[#cc1230] font-bold text-sm uppercase tracking-widest mb-3">Know Your Rights</p>
              <h2 className="text-4xl font-extrabold text-[#1b3a6b] mb-6">Your Rights as a Patient</h2>
              ...
              <ul className="space-y-3 text-gray-700">
                {[
                  ...
                  <li key={r} className="flex items-start gap-3">
                    <span className="text-[#cc1230] font-bold mt-0.5 shrink-0">—</span>
                    <span>{r}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200">
                <h3 className="text-xl font-extrabold text-[#1b3a6b] mb-2">24/7 Clinical Support</h3>
                ...
                <a href="tel:+18325551234" className="text-[#cc1230] font-bold text-lg hover:underline">(832) 555-1234</a>
              </div>
              <div className="bg-white rounded-2xl p-8 border border-gray-200">
                <h3 className="text-xl font-extrabold text-[#1b3a6b] mb-2">HIPAA Privacy</h3>
      ...
      <section id="insurance" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-12">
            <p className="text-[#cc1230] font-bold text-sm uppercase tracking-widest mb-3">Coverage</p>
            <h2 className="text-4xl font-extrabold text-[#1b3a6b]">Insurance We Accept</h2>
            <p className="text-gray-500 mt-3 max-w-xl">We verify your benefits at no cost before care begins — no surprises, no hidden fees.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <div key={card.title} className="border border-gray-200 rounded-2xl p-8">
                <div className="w-8 h-1 bg-[#cc1230] rounded mb-5" />
                <h3 className="text-2xl font-extrabold text-[#1b3a6b] mb-3">{card.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed mb-6">{card.body}</p>
                <ul className="space-y-2">
                  {card.items.map((item) => (
                    <li key={item} className="flex items-start gap-3 text-gray-700 text-sm">
                      <span className="text-[#cc1230] font-bold shrink-0">—</span>
                      {item}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-24 bg-[#f8f7f4]">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <div className="mb-12">
            <p className="text-[#cc1230] font-bold text-sm uppercase tracking-widest mb-3">Common Questions</p>
            <h2 className="text-4xl font-extrabold text-[#1b3a6b]">Frequently Asked Questions</h2>
          </div>
          <div className="space-y-3">
            {faqs.map((faq) => (
              <details key={faq.q} className="group bg-white rounded-xl border border-gray-200 overflow-hidden">
                <summary className="flex items-center justify-between cursor-pointer px-7 py-5 font-semibold text-gray-900 hover:text-[#1b3a6b] transition-colors list-none">
                  <span>{faq.q}</span>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 text-center text-white">
          ...
          <p className="text-blue-200 mb-8">Our coordinators are here around the clock.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+18325551234" className="border-2 border-white/50 text-white px-8 py-4 rounded-full font-semibold hover:bg-white/10 transition-colors flex items-center justify-center gap-2">

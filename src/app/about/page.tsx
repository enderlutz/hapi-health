  ...
  return (
    <>
      ...
      <section className="relative min-h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image
            ...
            unoptimized
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0c2d4e]/90 via-[#0c2d4e]/50 to-transparent" />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-48">
          <p className="text-teal-300 font-bold text-sm uppercase tracking-widest mb-3">Our Story</p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-[#1a7a72] font-bold text-sm uppercase tracking-widest mb-4">Who We Are</p>
              <h2 className="text-4xl lg:text-5xl font-extrabold text-[#0c2d4e] leading-tight mb-7">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
                <div className="grid grid-cols-2 gap-4 text-center">
                  {[
                    ...
                    <div key={s.l}>
                      <p className="text-2xl font-extrabold text-[#0c2d4e]">{s.v}</p>
      ...
      <section className="py-20 bg-[#faf9f6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <p className="text-[#1a7a72] font-bold text-sm uppercase tracking-widest mb-3">What We Stand For</p>
            <h2 className="text-4xl font-extrabold text-[#0c2d4e]">Our Core Values</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={v.title} className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
                <h3 className="text-xl font-extrabold text-[#0c2d4e] mb-3">{v.title}</h3>
      ...
      {/* Certifications */}
      <section className="py-16 bg-[#0c2d4e] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={c.title} className="bg-[#0f3a60] rounded-2xl p-8 border border-blue-900">
                <CheckCircle size={24} className="text-teal-400 mb-4" />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <p className="text-[#1a7a72] font-bold text-sm uppercase tracking-widest mb-3">Our Team</p>
            <h2 className="text-4xl font-extrabold text-[#0c2d4e]">Clinical Leadership</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={l.name} className="flex gap-6 bg-[#faf9f6] rounded-2xl p-8 border border-gray-100">
                ...
                <div>
                  <h3 className="text-lg font-extrabold text-[#0c2d4e]">{l.name}</h3>
                  <p className="text-[#1a7a72] font-semibold text-sm mb-2">{l.title}</p>
      ...
      {/* CTA */}
      <section className="py-14 bg-[#faf9f6] border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-extrabold text-[#0c2d4e] mb-3">Ready to work with our team?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="bg-[#0c2d4e] text-white px-8 py-4 rounded-full font-bold hover:bg-[#0a2540] transition-colors inline-flex items-center gap-2">
              Contact Us <ArrowRight size={16} />
            </Link>
            <a href="tel:+18325551234" className="border-2 border-[#0c2d4e] text-[#0c2d4e] px-8 py-4 rounded-full font-semibold hover:bg-[#0c2d4e]/5 transition-colors flex items-center justify-center gap-2">
